...
class PackageTypesControllerTest < ActionController::TestCase
  ...
  test "should create package_type" do
    assert_difference('PackageType.count') do
      post :create, package_type: { addons_allowed: @package_type.addons_allowed, name: @package_type.name, price: @package_type.price, tickets: @package_type.tickets, total_spots: @package_type.total_spots }
    end
  ...
  test "should update package_type" do
    patch :update, id: @package_type, package_type: { addons_allowed: @package_type.addons_allowed, name: @package_type.name, price: @package_type.price, tickets: @package_type.tickets, total_spots: @package_type.total_spots }
    assert_redirected_to package_type_path(assigns(:package_type))
  end
